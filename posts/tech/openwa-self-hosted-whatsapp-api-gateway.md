...
tags:
  ...
  - API
  - 自托管
summary: "OpenWA 是一个免费、开源、自托管的 WhatsApp API 网关，支持消息收发、群组管理、媒体处理，无需官方商业账号即可接入 WhatsApp 生态。"
---
...
> 仓库：[rmyndharis/OpenWA](https://github.com/rmyndharis/OpenWA)｜⭐ 1,870｜语言待定
