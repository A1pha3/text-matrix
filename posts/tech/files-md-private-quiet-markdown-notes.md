...
tags:
  ...
  - 笔记
  - 生产力
summary: "files.md 是一款极简开源笔记应用，为你提供一个安静、私密的空间用 Markdown 写笔记，没有云同步、没有协作、没有干扰，只有你和你的文字。"
---
...
> 仓库：[zakirullin/files.md](https://github.com/zakirullin/files.md)｜⭐ 468｜TypeScript
...
**一句话总结：** Obsidian 是瑞士军刀，files.md 是一支好写的笔。
