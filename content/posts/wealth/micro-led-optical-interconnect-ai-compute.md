...
全文按四步展开：先看互联为什么成为瓶颈，再对比现有方案为何触顶，然后拆解 Micro LED 的四大组件如何工作，最后落到产业格局与供应链机会。
...
1. **发送端**：GPU 输出的电信号进入调制电路，驱动单个 Micro LED 做 ON/OFF 调制。通道速率只有 2Gbps，几百个通道并行，每个通道的电驱动都极简单。
...
MOSAIC 的 50 米传输能力，让数据中心网络架构出现根本性变化。
...
| **思特威** | 2026年4月披露重点研发下一代 Micro LED CPO 技术，已成立专门事业部推进收发一体化系统 | 战略新方向 |
...
| **TIR 透镜** | 光路聚焦、耦合传输、光束准直，耦合效率提升2倍+ | 水晶光电、蓝特光学、中光学、炬光科技、腾景科技 |
...
| **CIS 传感器** | 接收端核心器件，适配并行光接收，成熟CMOS生态 | 思特威、豪威集团、格科微 |
