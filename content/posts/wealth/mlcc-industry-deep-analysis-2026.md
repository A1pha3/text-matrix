...
AI 服务器、车规、人形机器人三股需求几乎在同一时间撞上了 MLCC 的产能天花板。村田、三星电机、TDK 的稼动率已经普遍冲到 95% 以上，2026 年 Q1 高容 MLCC 交期从过去的 8-10 周拉长到 18-22 周，4 月起村田对 AI 服务器和高端车规级产品涨价 15%-35%，三星电机跟涨双位数。

MLCC 这轮行情不是消费电子周期复苏那种"库存去完就涨"的短逻辑，而是被 AI 算力基建的物理化需求逼出了结构性缺口。**景气持续时间会比一般元器件涨价周期更长**，因为供需两侧的拉力都是结构性的，不是季节性。

中低端产能已经卷成红海。国产侧真正能切下蛋糕的地方，是 **1μm 以下介质叠层、1000 层以上堆叠、镍内电极共烧** 这三个技术变量——靠它们从台系手里抢汽车、AI 服务器、工业控制三块附加值最高的市场。风华高科、三环集团已经在堆叠层数上摸到 1000 层门槛，是少数具备工程化能力的内资厂商。
...
它在电路板上做四件事：**旁路**（把噪声引到地）、**去耦**（瞬时供电）、**滤波**（选频）、**储能**（缓冲电压波动）。这四件事在每一块电路板上都要做无数次，全球每年消耗上万亿颗。
...
三个方向背后是同一个约束：在更小的空间里塞下更大的容值，还得扛住更高的电压和温度。尺寸、容值、可靠性三项必须同时推进，单项突破没有意义。
...
MLCC 看起来是一个"小零件"，但它的供需矛盾其实是 AI 算力基建物理化的一个切面。涨价不是催化剂驱动的短期脉冲，而是四条线同时绷紧的结果：芯片就近去耦的刚性需求、头部厂商超过 95% 的稼动率、高容 MLCC 工艺本身的低良率瓶颈，以及日韩台陆四股势力在 2024-2026 这两年的快速重构。

国产替代要打堆叠层数、介质厚度、共烧良率这三场硬仗，低端价格战没有出路。三环、风华能切下来多少，取决于 0.5μm 介质什么时候量产、车规认证什么时候通过。接下来 12-18 个月，盯住这场工程化战争的推进速度就够了。

## 自检清单

读完本文，你可以用以下问题自检：

- [ ] 能否说出 MLCC 在 AI 服务器主板上的三个主要作用？
- [ ] 能否解释为什么 MLCC 的介质厚度和堆叠层数决定了容值？
- [ ] 能否识别国产 MLCC 替代日系高端产品的三个技术瓶颈？
- [ ] 能否理解为什么 AI 服务器对 MLCC 的需求量是手机的 30 倍？
- [ ] 能否从本文的供需数据中，判断 MLCC 行业景气度的关键先行指标？

## 常见问题

**Q: MLCC 和普通电容有什么区别？**

MLCC 是多层陶瓷电容，通过堆叠数十到上千层陶瓷介质来实现高容量和小体积。普通电容（如铝电解电容）容量更大但体积也大，且高频特性不如 MLCC。在 AI 服务器这种需要大量高频去耦的场景，MLCC 不可替代。

**Q: 国产 MLCC 和日系 MLCC 的差距到底有多大？**

在介质厚度上，日系能做到 0.5-0.6μm，国产普遍在 1-2μm；堆叠层数上，日系最高 1600 层，国产头部 1000 层出头。差距在缩小，但同样尺寸下国产 MLCC 的容量仍然低于日系。真正要追平，需要 0.5μm 介质量产和车规认证通过。

**Q: 国产替代为什么不是"把价格做低就行"？**

MLCC 不是标准品。客户切换供应商需要重新做完整的可靠性测试和产线验证，周期以年计。如果国产 MLCC 良率只有 85% 而日系是 99%，客户承担的质量风险远大于价格折扣。这是国产替代的最大阻力。

**Q: 这轮 MLCC 涨价和 2018 年那轮有什么不同？**

2018 年是消费电子周期 + 渠道囤货，涨价来得快去得也快，随后就经历了大幅回调。本轮涨价由 AI 服务器、车规、机器人三股结构性需求驱动，供给侧产能扩张周期长（2-3 年），景气持续时间预计更长。但也要警惕，如果 AI 需求增速放缓，同样存在回调风险。
