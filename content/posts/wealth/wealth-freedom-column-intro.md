...
三条线：行业技术分析、投资机会梳理、个人财务与副业方法。

行业分析拆到技术层，不留在概念和情绪层面。投资梳理给具体标的和关注指标，不替你做决策。副业方法讲执行路径和验证步骤，不卖"轻松月入 X 万"。

覆盖行业以 AI 基础设施、半导体材料与工艺、被动元件、光通信为主。这些领域有几个共同特征：技术壁垒高，供需格局正在被 AI 需求重塑，国产替代有明确的工程化路径。选它们不是因为它们是唯一的方向，而是因为数据相对透明，技术逻辑可以验证，结论可以跟踪。
...
- 行业从业者：重点关注技术壁垒拆解和工程化路径部分，投资建议跳过。
- 投资人：重点关注供需数据、稼动率、交期和价格信号，技术细节按需查阅。
- 找副业方向的个人读者：关注验证方法和执行步骤，行业分析当作背景。

每篇文章末尾标注数据截止日期和适用边界。超过标注时间的数据，需要自己重新验证。
