...
**第一，ABF 膜在 AI 芯片封装中的位置短期内无法绕开**。占封装成本 60%+、一旦断供高性能计算倒退五年——这组数字不是修辞，是供应链单点失效的实际后果。AI 芯片大面积、多层数、高频率的特性决定了它比传统芯片更需要 ABF 膜。
...
**第三，材料层是弹性最大的方向**。在设备-载板-材料三层格局中，材料层的国产化率最低、战略卡位最重、技术差距最小。华正新材和生益科技分别走了"先量产再提良率"和"先突破物理极限再量产"两条路径——哪条路先跑通，哪条路就定义国产替代的下一个阶段。
