...
读这张图时记住一个判断：**mSAP 是 HDI 和 SAP 之间的桥**。苹果 iPhone 主板用了十多年 mSAP，线宽停在 30 μm；1.6T 光模块把 mSAP 的下限推到 25 μm，再往下就是 ABF 载板的世界，工艺和成本都换了一个量级。
...
这些差异解释了为什么价格能差 1 个量级——每道工序的精度要求都上了一个台阶。**代价是什么？** 良率下降——1.6T 光模块 mSAP 板的良率比苹果 mSAP 低 10% - 20%，这是价格溢价的另一个来源。
...
mSAP 不是一个被 AI 重新定义的新工艺——它一直是苹果 iPhone 主板的成熟方案。**改变的是它的需求结构**：从手机（8 美元 / 单元、面积缩小、出货微降）转向 AI 基础设施（25 - 30 美元 / 单元、供不应求、产能缺口明确）。
