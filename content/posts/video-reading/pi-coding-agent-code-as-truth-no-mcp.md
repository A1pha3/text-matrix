...
> 来源：微博视频 `https://video.weibo.com/show?fid=1034:5332798752358424`，@宝玉xp 于 2026-08-17 转发，时长 2:56。原视频摘要里两位 Pi 作者的核心观点：
> 
> 1. "代码即真相，代码不需要记忆系统，不需要 RAG，模型很擅长理解代码结构。"
> 2. "Bash 工具足够用，Bash 类似于编程语言，可以任意组合；大部分时候没必要 MCP，skill + 脚本足够。"
> 
> 本文基于该视频摘要 + 视频时长 2:56 + 评论区 4 条 + 我们独立复访 Pi 官方仓库（截至 2026-08-17 08:06 GMT+8 状态）整合而成。原视频完整逐字稿未拿到，**凡是从视频摘要之外补充的事实，全部标注来源**。
