...
Nick Saraev 教了 2000 多人怎么用 AI agent 干活，自己用 agent 跑着一门年入 400 万美元的生意。他的《AI Agents Full Course 2026》在 YouTube 上有 494K 观看，时长约 2 小时——但这不是你想象的那种课。
...
他的核心判断是：**当前的 AI agent，单看智力未必比人强，一次做对的能力也比人差。它们真正的强项是并行。** 同一个任务，你可以同时开很多个 agent 实例，各试各的路子，靠速度和数量堆出更好的结果。所以这门课的重点不是调某个 agent 变聪明，而是**怎么用提示词架构把多个 agent 编排起来**。

[YouTube 原片](https://www.youtube.com/watch?v=EsTrWCV0Ph4) ｜ 频道 [@nicksaraev](https://www.youtube.com/@nicksaraev)
...
这个 demo 就是全片的目标态：**把工作拆散到多个浏览器实例，每个子 agent 一块独立工作区**。后面两小时讲的所有技巧，都是为了搭出这种编排。
...
这三步每一步都能优化——观察能优化、思考能优化、行动也能优化，这门课就是教这个。
