...
Recursive Superintelligence（下文简称 RSI）押注的递归自我改进，不是"AI 自己升级 AI"那么简单。田渊栋在访谈里说得很具体：先让 AI 接手搭环境、跑实验、改配置、排错、整理结果这些重体力劳动；再让它参与发现新逻辑、新强化方式和新实验方向。最终要提高的不是某个榜单分数，是 knowledge discovery rate——知识发现速率。
...
| 组织 | 前沿模型竞争越来越像组织工程，反馈速度、push back 和研究品味直接影响结果。 |
| 个人 | 当公司开始"蒸馏"员工、岗位水位下降，个人不能只依赖大厂插槽，而要持续产出新判断、新数据和新作品。 |

三条线指向同一个判断：AI 正在开始自动化研究本身，而旧的组织关系和职业路径却没跟上。
...
RSI 容易被读成某个模型突然觉醒然后无限自我升级。田渊栋说得很朴素：用 AI 优化 AI 自己的环节，让 AI 变强，再继续迭代。
...
RSI 的第一道硬墙不是写代码，是评估。AI 开始自主设计实验、分析结果后，人类还能不能当可靠评判者？田渊栋的回答很克制：至少现在，AI 的评估能力还达不到人类的水准，短期内仍需要人类把关。但 AI 继续变强后，很多评估会从客观标准转向主观判断——代码结构、模块划分、研究方向价值，本来就没有单一答案。

评估随任务难度逐层上移：执行层靠单元测试、benchmark 和指标；工程层看结构、稳定性、可维护性；研究层看有没有新洞察；系统层不再评价单次输出，而是人与 AI 合作后的整体产出。
...
当前大模型大量依赖思维链（Chain of Thought），把推理过程写成自然语言。田渊栋并不否定这条路线——它实用、可解释、好训练，也是今天模型推理能力的重要来源。但人类很多思考并不是先以句子发生，而是以图像、结构、模糊方向、并行候选路径出现，最后才压缩成语言。
...
以 RSI 为代表的 Neolab（硅谷 101 对新一代前沿 AI 实验室的称呼）机会也正在这里。大公司擅长确定性 scaling、平台工程、基础设施和分发；这类新实验室更适合把创始团队的信念压在尚未成为共识的新方向上。它的风险同样明显：估值容易提前透支，短期产品化压力会逼迫研究过早承诺，明星团队如果没有共同评估框架，分歧会快速放大。

RSI 的特殊之处在于，它押的是"实验室自身的工作方式会被 AI 改写"。如果成立，RSI 的价值不只是做出一个模型，而是掌握一台持续产生研究进步的机器；如果不成立，它就会面对高估值和长周期研究之间的张力。

## 员工蒸馏会反噬数据质量

访谈后半段最尖锐的问题，是"员工蒸馏"——公司沉淀员工的工作过程、代码、文档、沟通和决策记录，用来训练内部 AI，让模型学习员工如何完成任务。
...
这场访谈传播最广的比喻，是鱼缸。田渊栋说，如果一个人只是从一个大厂跳到另一个大厂，被裁后再跳到下一个，就像鱼在水坑里跳。问题是水正在干涸。
...
落到个人手上，四个问题可以这样自问：不用"超级智能"四个字，能不能解释 RSI 想提高的到底是哪种速率？能不能说清"AI 写代码"和"AI 做研究"之间缺了哪几层能力？能不能理解田渊栋为什么把可解释性、潜在推理和顿悟放在一起谈？能不能写下自己当前职业里的一个鱼缸，以及一项离开鱼缸仍有价值的能力？

这些问题如果都有答案，RSI 就不只是一个 46.5 亿美元估值的新实验室。它照出的是 AI 研究的下一次换挡，也是旧水位下降时，每个人愿不愿意重新训练自己的生存方式。

## 谁该看原片

不赶时间、只想抓住主线的人，读这篇基本够用：RSI 押的不是模型而是研究速度，评估与可解释性在工程上的位置，模型竞赛背后的组织结构，以及员工蒸馏对个人职业位置的冲击。

想补上下文的人再翻 1 小时 32 分钟的原片：联合创始人各自的分工、RSI 办公室的 office tour，以及田渊栋对潜在推理落地节奏、更口语化的技术推演，都在视频里有更完整的展开。转写稿的逐段原文可对照 36 氪授权文字稿。由于 B 站与 YouTube 直抓字幕受限，这篇没有按时间点标注关键论点，需要定位原片的读者以文字稿章节为准。
