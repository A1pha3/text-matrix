...
三条线合起来就是整场访谈的底色：AI 自动化研究正在改变先进生产力，旧组织关系和职业路径还没跟上。
...
Neolab 的机会也正在这里。大公司擅长确定性 scaling、平台工程、基础设施和分发；小型前沿实验室更适合把创始团队的信念压在尚未成为共识的新方向上。它的风险同样明显：估值容易提前透支，短期产品化压力会逼迫研究过早承诺，明星团队如果没有共同评估框架，分歧会快速放大。
