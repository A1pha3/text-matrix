...
> **阅读目标**：看懂人形机器人过去两年“进化这么快”的真实驱动力——不是大脑变聪明，是电机/减速器/丝杠/力矩传感器四条供应链国产替代 + 整机系统整合，把单台成本从 80 万压到 10 万。下面「这篇文章在回答什么」加各级标题即目录（TOC），可按需跳读。
...
但硅谷 101《空翻之后，它还要学会接住一片落叶？拆解机器人「肉身」、量产与供应链》（BV1hjV96MEUE，38 分钟，2026-06-01 发布）这期节目里嘉宾王闯说过一句更直白的话：「**如果把机器人拆开来看，厉害的不是某一个动作，是它背后那套复杂的身体系统。**」

这期节目的嘉宾三人组——智元机器人合伙人 / 高级副总裁 / 通用业务部总裁王闯、前特斯拉人工智能硬件负责人 Kerry 刘向科、某机器人公司前采购总监（匿名）——刚好覆盖了「整机厂 + 头部 AI 公司硬件 + 供应链」三个视角。这篇文章以这期节目为骨架，按**电机 / 减速器 / 丝杠 / 力矩传感器**四条供应链主线拆开机器人的「肉身」，再说清楚为什么「单点技术 vs 系统整合」在 2026 年这个时点变得关键。
...
「**空翻 → 半马 → 工厂分拣**」这条路径，是从舞台炫技过渡到工业部署。三件舞台动作每件背后对应的工程难度都比上一件高一个量级，但难度跃升最陡的不是动作本身，是**机器人不能停**。
...
_示意图：执行器线（电机 + 减速器 + 丝杠 + 力矩传感器）占整机 BOM 约 40%——这是过去两年供应链变化最剧烈的一环。_

执行器线、感知线、结构线、计算线、电池线这五条线里，**执行器线最贵也最难**——硅谷 101 那期节目里三位嘉宾都认这一点。
...
所以：**整机厂如果想 2026 年量产 1 万台以上，国产减速器供应必须打通**。智元、宇树、优必选的做法都是「**自研关节模组 + 投资 / 战略绑定国产减速器厂**」。
...
这是机器人圈 2025 年下半年开始「分水岭」的原因。拆开来讲：
...
机器人圈过去两年最大的变化不是「谁会空翻」，是「**电机 + 减速器 + 丝杠 + 传感器四条供应链线国产替代基本完成，量产成本从 80 万 / 台降到 10 万 / 台**」。

下一个分水岭是**软件调度能力**——同样一台 8–12 万人民币的硬件，跑特斯拉 VLA 模型能在弗里蒙特分拣电池，跑传统控制器只能在舞台上踢腿。

2026–2028 年，机器人圈的竞争重心会从「**单点技术领先**」转向「**硬件 + 软件 = 整机可靠性**」。空翻、半马这些舞台动作还会继续有人做，但**真正在 8 小时班次里不出错的机器人**，才是 2028 年能拿 100 万台订单的那批。
...
- **「机器人进化快 = 大脑（AI）变强」**——片面。过去两年真正的跃升在"肉身"：电机/减速器/丝杠/力矩传感器四条供应链国产替代 + 整机整合，把单台成本从 80 万压到 10 万。
- **「会空翻/半马 = 能量产干活」**——不对。空翻、半马是"表演型"（20×–50× 难度），工厂 8 小时不摔倒是"实用型"（100×–200× 难度）；差的那 5–10 倍才是量产门槛。
- **「单点技术最强就能赢」**——2026 年这个时点不成立。决定跑不跑得出来的是系统整合能力 + 供应链成熟度，中国公司量产过千台靠的正是供应链，不是单点技术更强。

## 十、自测清单

读完可以对着几个问题自测——也拿宇树 / 特斯拉 / Figure 几个例子当参照：

- [ ] 说得出一台人形机器人执行器线（电机/减速器/丝杠/力矩传感器）为什么最贵最难吗？
- [ ] 讲得出谐波减速器为什么是"瓶颈中的瓶颈"（技术壁垒 + 产能 + 价格）吗？
- [ ] 说得清"空翻"和"工厂分拣"之间差的 5–10 倍工程难度具体是什么吗？
- [ ] 列得出判断一家人形机器人公司该不该看的那 4 件事吗？

## 十一、参考与延伸

想继续深入，下一步可以直接看源节目和各家公开规格：
