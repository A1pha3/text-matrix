...
lastmod: "2026-09-14T10:30:00+08:00"
...
姚顺宇看 AI 的角度，和典型的模型工程师不太一样。清华本科、斯坦福博士，原本做理论物理，研究过非厄米系统、量子物理和高能物理。读完博士，他离开了学了 9 年的物理，转去一个完全陌生的行业——他自己说，这是人生里最大的跨步。
...
他对研究工作的两个判断由此而来：模型研究的重心不是找更高分的点子，而是建立一套不容易自欺的诊断体系；系统工程也不是研究之外的脏活——在今天的大模型训练里，它就是研究方法的一部分。谁能更稳定地识别 bug、隔离变量、约束指标、抵抗局部最优，谁就更接近真正有效的进展。
...
硬蒸的好处是快。teacher（教师模型）吐出什么，你就学什么，局部 benchmark 甚至可能立刻变好看。但问题同样直接：你学到的是“怎样像它那样回答”，不是“这个任务该怎么拆、反馈链怎么搭、哪些能力值得优先优化”。训练目标一旦被外部模型替你定义，你自己的研究判断就会变薄。
...
如果用今天更熟悉的术语对照，硬蒸更接近直接拿 teacher 输出做一轮 SFT（监督微调）；“聪明的蒸”则延伸到筛选后的 SFT、偏好对、奖励模型、DPO（直接偏好优化）或 RLHF（基于人类反馈的强化学习）这一整条后训练链。真正要分清的是：训练目标到底由谁定义——外部模型替你定义，还是你借它来强化自己的反馈系统。
...
更关键的是，coding 把“工具使用”和“环境交互”这两个 agent 难题，放进了一个数据充足、验证明确、迭代速度快的场景里。coding 上的很多进展，并不只服务代码补全本身，而是在给更通用的 agent 能力打样。
...
姚顺宇先后在 Anthropic 和 Google DeepMind 担任研究科学家，参与过 Claude 3.7、Claude 4.5 和 Gemini 3 的训练，这让他的比较少了外部评论里常见的空泛感。谈 Anthropic 时，他强调的是 top-down（自上而下）机制能成立的前提：做技术决策的人，既要在技术上服众，也要在组织上有真正的拍板权。这样的组合并不常见。

谈到 Google，画风就不同了。公司整体仍偏 bottom-up（自下而上），但至少在 pre-train 这件事上，分工、owner 和验证框架已经很清楚。他说 pre-train 进入了 Google 的舒适区，不是说事情变简单，而是 Google 的工程管理和大项目推进方式，恰好特别适合这类问题。
...
按他的判断，组织问题是技术 leader 的问题：这个人不只要能拍方向，还得能维持整个实验体系的信噪比。系统越大，局部最优、指标美化、资源错配就越容易把组织带偏；leader 的价值在于这些偏移刚出现时就能识别出来，必要时亲自下场把问题重新拆开。同时，即便某件事不是自己亲手做，他也能理解为什么别人的工作重要、为什么它值得被容纳在系统里——前者保证系统不在关键处断裂，后者保证系统不会因为过度单一而失去探索能力。好的 AI 组织不靠明星个人撑场面，靠一整套能让普通人稳定做出高水平工作的系统。
...
整场访谈留下来的，是一种看问题的方法：把注意力从神秘故事和个人神话，移到问题定义、评估框架、组织结构和产品形态上。这篇整理把 4 小时压缩成了可以一次读完的正文。如果你在做模型训练、后训练或强化学习，想听一线研究者怎么拆 Pre-train、蒸馏、评估框架和系统工程，读本文基本够用——他的关键判断和比喻都已保留。
...
| 01:37 | 高能物理 |
| 01:44 | 物理与 AI |
| 01:53 | 在 Anthropic 训练 Claude 3.7、4.5 |
| 02:36 | AI 本质是简单的 |
| 02:42 | 在 Google DeepMind 训练 Gemini 3 |
| 03:02 | Pre-train 也是一种 RL |
| 03:08 | 技术预测 |
| 03:14 | 组织搭建 |
| 03:24 | 集体主义胜利 |