...
## 1. 正确预期：Seedance 2.0 擅长什么，不擅长什么

### 1.1 它更像"镜头生成器"，而不是"成片导演"
...
这就是"剪辑师思维"——降低失败率的工作方法。

### 1.2 影响成片质量的，不只是提示词

很多教程把问题都归结为"提示词不够强"。这只对了一半。Seedance 2.0 的结果，通常由以下三项共同决定：

- **镜头设计**：你能控制景别、运动、时长、叙事目的。这决定了结果是不是可剪、可接、可讲故事。
...
**镜头 1**（交代场景）：城市天际线，云层缓慢移动。Wide shot, locked frame。冷蓝清晨、轻雾。3-5 秒。作为开场建立氛围。

**镜头 2**（引出角色）：女主角，走向地铁入口。Medium shot, tracking shot。纪实电影感。4-6 秒。与镜头 3 保持服装一致。

**镜头 3**（情绪靠近）：女主角面部，短暂停顿后抬眼。Close-up, static shot。柔和背光。3-4 秒。为后续内心戏留白。
...
很多人听过"动作只写一个"，然后理解成"一句里只能出现一个动词"。这不够准确。真正的原则是：**一个镜头只保留一个主要动作意图。**
...
镜头模块的作用，是把"你想拍什么"翻译成"摄影机应该怎么工作"。
...
## 4. 文生视频和图生视频，写法为什么必须不同

### 4.1 文生视频：文字承担"定义世界"的职责
...
图生视频的目标不是"重新定义主体"，而是"在保留主体的前提下，让它动起来"。因此图生视频提示词要更短、更克制。
...
- **角色包**（锁定人物身份）：准备正面、侧面、四分之三侧面，各自单独裁切。
...
这些模板不是复制粘贴后一定直接出片，它们体现的原则是：每个镜头只服务一个明确目标。
...
常见误区中，有两个是新手最容易踩的。第一，认为提示词越长越专业——实际上更长只代表变量更多，不代表控制更强，专业提示词靠的是信息优先级清晰。第二，认为生成结果漂亮就说明镜头成功了——一个镜头是否成功，标准首先是它有没有完成叙事任务。

关于否定提示词：在视频生成任务中，正向描述通常比堆砌否定描述更稳定。与其写"不要路人、不要抖动、不要背景乱"，不如直接写：
...
关于角色一致性：参考图只能提高上限，真正决定一致性的，还包括服装设定、镜头光线、场景连续性和提示词克制度。

---

## 12. 常见问题

**新手最该先练什么？** 先练分镜拆解，而不是先背很多提示词。不会拆镜头的人，即使抄到好提示词，也很难稳定复现。

**一条视频应该先做文生还是图生？** 如果还在找视觉方向，先用文生视频探索；如果已有角色或产品主视觉，需要保持一致性，就尽快切到图生视频。

**什么时候该放弃继续调一个镜头？** 当你连续几轮都在改风格词，但主体、动作和镜头目的仍然不清楚时，就应该停下来重写镜头定义，而不是继续在同一版本上硬调。

**怎样提高整条片子的统一感？** 最有效的方式不是给每一镜都加更多华丽词，而是提前固定三件事：统一风格锚点、统一参考素材、统一分镜节奏。
...
文档信息：Seedance 2.0 视频制作指南 | 更新日期：2026-03-30 | 建议用法：先按第 2 节写镜头表，再回到第 7 节套模板生成。