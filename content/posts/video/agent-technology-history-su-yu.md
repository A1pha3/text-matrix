...
# Agent技术全史：从1960年代逻辑代理到2026年通用数字代理的史诗旅程

> **目标读者**：想系统理解 AI Agent 技术演进史、从学术脉络到产业落地的开发者与研究者
> **核心问题**：Agent 技术经历了怎样的范式迁移？为什么 Language Agent 在过去三年迎来爆发？OpenClaw Moment 意味着什么？
> **难度**：⭐⭐⭐⭐⭐ | **来源**：微博 @张小珺Benita，2026-05-01 | **嘉宾**：苏煜（俄亥俄州立大学计算机系教授、NeoCognition 创始人）
...
| 项目 | 内容 |
|------|------|
| 标题 | 【Agent的综述】和苏煜聊Agent技术史、OpenClaw Moment、边界的消弭和社会的辐射 |
| 频道 | 张小珺Benita（财经作者、播客《张小珺Jùn｜商业访谈录》主理人，17.4万粉丝） |
...
## 一、嘉宾背景：见证Agent完整周期的学者

苏煜是俄亥俄州立大学计算机系教授，同时是创业公司 **NeoCognition** 的创始人。2025年荣获"斯隆研究奖"（Sloan Research Fellowship），这是美国青年学者的最高荣誉之一。

值得注意的是，苏煜是**最早从 Semantic Parsing（语义解析）领域转型做 Language Agent 的学者之一**——这个转型本身就是一个重要的技术信号：当一个领域的顶尖学者集体转向新方向，往往意味着范式转移正在发生。
...
### 2.1 第一幕：Logical Agent（1960年代—1990年代）
...
苏煜是这一领域的资深学者，他的研究为后来 Language Agent 的爆发埋下了重要的学术基础——**Language Agent 的核心理念"用语言作为推理和交互的媒介"，在语义解析中已有雏形**。

### 2.4 第三幕：Language Agent（2019—2026年，至今仍在加速）
...
2022年11月，ChatGPT 的发布让人们意识到：**语言模型已经足够好，可以替代大量白领工作**。它解决了"表达"的问题——知识的检索与组织。

### OpenClaw Moment 的本质

OpenClaw 是一个高度可扩展的 AI Agent 框架，支持多模态感知、工具使用、长期记忆和自主决策。苏煜认为它与 ChatGPT Moment 有"非常多相似的地方"，核心在于：

1. **能力的量变到质变**：当 Agent 能够自主完成复杂的多步骤任务时，其能力曲线突破了临界点
...
苏煜创立的 **NeoCognition** 最近完成了**$40M（4000万美元）种子轮融资**，是 2026 年 AI 领域最受关注的种子轮之一。
...
**适合观看的人群**：
- AI 研究者和开发者，想系统了解 Agent 技术演进
- 技术管理者和投资人，评估 Agent 赛道机会
- 对 AI 技术感兴趣的非技术背景读者，想了解 Agent 到底是什么、能做什么

**优势**：
- 苏煜同时具备学术深度和创业视角，是极少数见证过完整 Agent 演化史的学者
- 节目信息密度极高，两个多小时的对话几乎没有废话
- 中文语境下的顶级技术访谈，内容比英文播客更贴近中国读者

**局限**：
- 作为播客，无法展示技术 demo，对视觉学习者不够友好
- 部分深层技术讨论需要一定背景知识才能完全理解
