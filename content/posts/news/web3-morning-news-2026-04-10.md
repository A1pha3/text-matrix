...
**全球加密货币总市值：** $2.44T，24小时上涨 +0.72%

**CMC20指数：** $146.86（1小时 +0.35%，24小时 +0.97%，7天 +6.80%）
...
**周涨幅领先者：**
- Hyperliquid (HYPE): +12.04%（7天）
- Bitcoin (BTC): +7.21%（7天）
- Ethereum (ETH): +6.38%（7天）
- Solana (SOL): +5.51%（7天）
- Cardano (ADA): +6.03%（7天）
...
- **"Are altcoins outperforming Bitcoin?"** - 主流代币 vs BTC表现对比
