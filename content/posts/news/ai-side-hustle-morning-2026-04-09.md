...
**来源**: [V2ex](https://www.v2ex.com/t/1204300)
**发布者**: [aikilan](https://www.v2ex.com/member/aikilan)
**摘要**: 新生事物快速迭代，Skill、Harness、OpenClaw、Hermes 等概念让人眼花缭乱。网友建议：静待市场稳定，不必太过焦虑；拥抱变化但不迷信变化；先搞清楚自己要做什么，再找对应的AI工具。

**热评摘录**:
- "基本 3-6 个月都会淘汰一大堆，大多数都没必要学"
- "3 年不学 AI，好像也没错过啥"
- "AI 大模型本身是 99，这些工具充其量就是 1"

---

### 公司要开 AI 分享会，求一些 idea

**来源**: [V2ex](https://www.v2ex.com/t/1204230)
**发布者**: [PepperEgg](https://www.v2ex.com/member/PepperEgg)
**摘要**: 公司每周五分享AI使用与发现，内容越来越卷。55条回复提供选题建议：OpenClaw + Skills 提效方案、Harness Engineering 包装 Workflow、SDD/TDD、意图识别、链式调用、Claude Code 技巧、AI 不能做什么、数据质量决定 AI 表现等。
