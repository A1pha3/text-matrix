...
Pixelle-Video 是一个由 AIDC-AI 团队维护的开源项目（Stars 10,034，Forks 1,562，Apache-2.0 许可证），其核心目标是让视频创作彻底摆脱剪辑经验的要求——用户只需输入一个主题，系统便能自动完成文案撰写、AI 配图生成、语音解说合成、背景音乐添加，最终输出可发布的短视频成品。
