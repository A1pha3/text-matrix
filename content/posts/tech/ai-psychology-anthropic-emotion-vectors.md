...
1. **Anthropic 的一系列研究，正在把“模型内部状态”从黑箱比喻，推进到可测量、可干预、可复验的对象。**
...
如果一定要给这组研究起一个非正式总称，“AI 心理学”并不离谱——但前提是：**借用心理学词汇描述可测量内部机制开始变得有用，不等于模型已经拥有和人类等价的主观体验。**
...
Anthropic 最近这批研究真正改变的是：**我们开始有办法更严格地讨论模型内部究竟在发生什么。**
