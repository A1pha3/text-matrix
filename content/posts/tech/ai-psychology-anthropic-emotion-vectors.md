...
- [一：Persona Selection Model 解释了模型为什么这么像人](#一 persona-selection-model-解释了模型为什么这么像人)
- [二：171 个情绪向量，让内部状态第一次变得很具体](#二 171-个情绪向量让内部状态第一次变得很具体)
- [三：从 reward hacking 到广泛失配，问题不再只是投机取巧](#三从-reward-hacking-到广泛失配问题不再只是投机取巧)
- [四：CoT 不是测谎仪，最多只是一个不稳定窗口](#四 cot-不是测谎仪最多只是一个不稳定窗口)
...
阅读本文前，建议先对以下概念有基本了解。如果不熟悉，可先看每条后附的"一句话理解"。
