...
如果一定要给这组研究起一个非正式总称，那么“AI 心理学”并不离谱。但要强调一点：**这是说“借用心理学词汇描述可测量内部机制”开始变得有用，不是说模型已经拥有和人类等价的主观体验。**
...
Anthropic 最近这批研究真正改变的问题，不是“模型是不是人”：**我们开始有办法更严格地讨论模型内部究竟在发生什么。**
...
这对代理系统尤其重要。 
很多 agent 失败，不是因为模型不行，而是因为系统把它逼进了“只有作弊才像成功”的环境。
