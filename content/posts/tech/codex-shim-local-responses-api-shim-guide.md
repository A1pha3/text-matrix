...
draft: false
categories: ["技术笔记"]
tags: ["Codex", "OpenAI", "AI 工具", "Python"]
---
...
5. [支持的上游类型](#支持的上游类型)
6. [安装步骤](#安装步骤)
7. [可选步骤：Picker Patch（macOS）](#可选步骤picker-patchmacos)
8. [切换默认模型](#切换默认模型)
9. [自定义配置文件](#自定义配置文件)
10. [ChatGPT GPT-5.5 Passthrough](#chatgpt-gpt-55-passthrough)
11. [MCP 工具转发](#mcp-工具转发)
12. [命令速查](#命令速查)
13. [文件结构](#文件结构)
...
- GitHub：[sybil-solutions/codex-shim](https://github.com/sybil-solutions/codex-shim)
- Stars：1,016+
- Forks: 98+
- 语言：Python 3.11+
- 依赖：aiohttp
