...
source_key: "gh:Egonex-AI/Understand-Anything"
aliases:
...
- [项目现状](#项目现状)
- [系统地图](#系统地图)
- [它和"把仓库塞给 LLM"的区别](#它和把仓库塞给-llm的区别)
- [knowledge-graph.json 里有什么](#knowledge-graphjson-里有什么)
- [一次真实任务如何流过系统](#一次真实任务如何流过系统)
- [Dashboard 提供的视角](#dashboard-提供的视角)
- [快速上手](#快速上手)
- [多平台支持的实现方式](#多平台支持的实现方式)
- [Tree-sitter 与 LLM 的分工](#tree-sitter-与-llm-的分工)
- [图谱即文档](#图谱即文档)
- [v2.7.3 的关键变化](#v273-的关键变化)
- [与同类工具的差异](#与同类工具的差异)
- [适用边界](#适用边界)
- [采用建议](#采用建议)
- [自测题](#自测题)
...
3. **如何用 Understand Anything 加速新人 onboarding？**
   ...
   - 用 `/understand-chat` 问 5 个真实 onboarding 问题（例如："请求从入口到数据库经过哪些层？""哪个模块处理鉴权？""某个 job 依赖哪些 service？"）
   - 用 `/understand-diff` 看 PR 的影响面
   </details>
...
5. **如何在团队里试用 Understand Anything？**
   ...
   - 用 `/understand-chat` 问 5 个真实 onboarding 问题
...
5. 用 `/understand-chat` 问几个关于项目结构的问题，验证图谱的准确性
