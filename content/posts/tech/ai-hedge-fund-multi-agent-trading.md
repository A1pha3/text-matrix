...
- [§4 项目中的 Agent 是两类角色协作](#§4-项目中的-agent-是两类角色协作)
  ...
  - [§4.3 两个决定结果的关键节点](#§43-两个决定结果的关键节点)
...
- [§10 这个项目可迁移的 5 个设计模式](#§10-这个项目可迁移的-5-个设计模式)
...
`AI Hedge Fund` 收敛设计做得好的地方，是它对多 Agent 系统里三个容易失控的环节做了约束：

- 让分析负责发散
- 让风控负责约束
- 让最终决策只在安全动作空间内发生

这个仓库有教学价值，也能落到具体代码结构，适合作为多 Agent 开源项目的研究样本。  
