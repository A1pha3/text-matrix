...
- 高通在 CES 2026 / MWC 2026 上**把 AI 切成「个人 AI + 物理 AI（Physical AI）」**两块的战略意图，背后的芯片 / 通信 / 操作系统的工程逻辑
- 「**算力、内存、功耗不可能三角**」在端侧 AI 时代的具体形态，以及高通 Snapdrgaon X / 8 Elite 这一代 NPU 是怎么把「三角」压成「一条窄边」的
- 高通骁友会 5 周年（2025-05-23 北京）现场 4 个体验——AI 手机随音而舞、机器人踢足球、智能眼镜导航、五屏联动的智能座舱——背后**同一条技术主线**：异构计算 + 端侧大模型 + 实时连接

---

## 写在前面

2025 年 5 月 23 日，高通骁友会 5 周年线下派对在北京举办。硅谷 101《对话高通：智能体爆发、6G 与 Physical AI 背后的大赢家》（BV1fuVZ6bEAD，35 分钟，2026-06 上旬发布）就是这期活动的现场对谈录。嘉宾是高通公司全球副总裁、中国区研发负责人、IEEE Fellow 徐晧。节目信息密度高，但核心论题只有一条：
...
这篇文章以这期硅谷 101 节目为骨架，叠加徐晧 2024 年公开访谈、高通骁友会 5 周年活动现场报道（公开新闻稿）、CES 2026 + MWC 2026 高通两场公开主题演讲、公开的 Snapdragon X Elite / Snapdragon 8 Elite NPU 数据，把「端侧 AI 智能体元年」这件事从芯片、通信、操作系统、智能体四层串起来看。
...
把「端侧 AI」理解成「手机装了个大模型」是早期 2023 年的看法。2026 年的端侧 AI 实际是三层基础设施在动：
...
这三层不是孤立的。它们**必须同时跑起来**才能撑起「以智能体为中心的人机交互新范式」——这件事是徐晧在 5 周年现场反复强调的判断。

把三层绑起来看，才能理解为什么 2026 年是「智能体元年」——**前两层是 2023-2025 年三年累积的硬件准备，第三层是 2025-2026 年软件/系统准备**。三层同时就绪，应用层才敢真把智能体调度从云端搬到端侧。
...
把「45 TOPS」当成端侧 AI 的全部，是低估了高通 NPU 的工程深度。**真正跑端侧大模型**需要**异构计算**——CPU 跑调度 + 控制流，NPU 跑张量 / 矩阵推理，GPU 跑图形 / 视觉推理。三者协同才让一个 Agent 任务能在 8 瓦功耗下完成。
...
### 4.1 智能体 ≠ Chatbot：3 个根本性差异

「智能体元年」这个说法 2024 年就开始被宣传，但 2024 年的「智能体」本质是**云端 chatbot 加 function calling**。2026 年的「智能体」是**端云协同的 Agent Runtime**。三处根本性差异：
...
拆抽象机制看具体流转。用户在骁友会现场戴上 AR 眼镜说一句「导航到最近的中关村咖啡店」，从麦克风收到语音到镜片出现导航指引，**全程 1 秒内** 走完下面这条路径：
...
把全文压成一段。2026 年的端侧 AI 智能体元年，「**最聪明的模型**」不一定赢，「**最稳的端云协同**」一定赢。这句话有两层含义：

- **端侧稳**：NPU 算力 + 内存带宽 + 功耗控制 三角平衡，跑得动 7B-30B 模型的设备
- **云端稳**：5G Advanced + 6G 路线图 + 端云协同 OS，让端侧模型和云端模型无缝切换
...
去火星是 SpaceX 的故事，去端侧是高通的故事。两条故事在 2026 年 6 月这一刻看起来都还没有走完，但**方向已经清楚**——剩下的就是工程。
