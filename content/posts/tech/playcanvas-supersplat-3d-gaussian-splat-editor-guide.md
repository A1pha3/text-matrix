...
- 核心特点：结合了**可微渲染**与**自适应密度控制**，既保证渲染质量，又支持实时交互
...
SuperSplat 把过去只能在专业研究工具中操作的 splat 编辑能力，带到了浏览器中。开源、Web 原生、多语言支持，加上 PlayCanvas 团队的 WebGL 积累，使得它成为 3DGS 入门和实际生产的可用工具。
