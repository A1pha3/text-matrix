...
+++
# pi：53K 星全能 AI Agent 工具包，CLI+TUI+API+Slack 一站搞定

> 告别工具碎片化，一个命令行掌控 AI 工作流。
...
- **53K+ ⭐**：Trending 第二名，大量开发者验证过
- **Python + 模块化**：按需替换组件，不用改框架
- **从本地到云端**：CLI → TUI → API → Slack → vLLM Pod，按场景选入口
- **pip 装完就能用**：不需要额外配置运行环境
