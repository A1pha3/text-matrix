...
Linux 是开源世界最标志性的项目之一，而 **torvalds/linux** 仓库（https://github.com/torvalds/linux）则是这一切的核心。截至本文撰写时，该仓库拥有超过 23.1 万颗星标、6.2 万个分支，主要语言为 C（超过 1.4GB 代码量），是全球最大的单体开源代码库之一。本文帮助有一定 C 语言和操作系统基础的工程师，系统掌握 Linux 内核的开发路径——从读懂源码结构开始，到本地编译验证，再到向上游提交第一个补丁。
