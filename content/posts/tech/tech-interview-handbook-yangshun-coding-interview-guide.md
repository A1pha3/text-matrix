...
source_key: "gh:yangshun/tech-interview-handbook"
...
1. **理解 Tech Interview Handbook 的核心价值** — 了解免费技术面试准备手册的优势和使用场景
2. **掌握 Blind 75 到 Grind 75 的演化** — 学会如何选择适合自己的题目清单
3. **学会准备技术面试的全流程** — 从简历、算法、行为面试到薪资谈判
4. **了解 STAR 法则** — 掌握行为面试的回答框架
5. **掌握 4 周冲刺计划** — 学会如何高效准备技术面试
...
1. [一句话定位](#一句话定位)
2. [为什么这个项目经久不衰？](#为什么这个项目经久不衰)
3. [核心内容速览](#核心内容速览)
4. [与 Cracking the Coding Interview（CTCI）的差异](#与-cracking-the-coding-interviewcracking-the-coding-interview的差异)
5. [适用人群](#适用人群)
6. [快速上手（4 周冲刺计划）](#快速上手4-周冲刺计划)
7. [自测题](#自测题)
8. [练习](#练习)
9. [进阶路径](#进阶路径)
10. [资料口径说明](#资料口径说明)
...
**Q：Tech Interview Handbook 和 LeetCode 刷题有什么区别？**

A：LeetCode 提供题库，Tech Interview Handbook 提供"刷哪些题、怎么刷、面试全流程怎么准备"的指导。建议配合使用：用 Tech Interview Handbook 制定计划，用 LeetCode 刷题。

**Q：Grind 75 和 Blind 75 有什么区别？**

A：Blind 75 是 yangshun 在 Blind（美国匿名职场社区）发布的精选 75 题。Grind 75 是 Blind 75 的"v2"，题量更大，按时间安排分级。如果你准备时间充裕（8-12 周），选 Grind 75；如果时间紧张（4 周），选 Blind 75。

**Q：STAR 法则对国内面试同样重要吗？**

A：重要，但要注意：国内大厂（尤其阿里、字节）还会追问"你在这个项目里具体做了什么"，需要更深的细节准备。建议准备 10 个最强 STAR 故事，每个故事准备 3-5 层深度的细节。

**Q：简历中的"必须有数字"怎么理解？**

A：每个项目描述都要有量化结果。比如：
- ❌ "优化了 API 性能"
- ✅ "将 API P99 延迟从 200ms 降到 120ms，QPS 提升 40%"

**Q：薪资谈判章节对国内 offer 有用吗？**

A：有用，但策略不同。国内 offer 谈判更看重：多头 offer 对比、股权/RSU 细节、签字费/搬迁费/年终奖结构。建议参考章节思路，但结合国内实际情况调整。
