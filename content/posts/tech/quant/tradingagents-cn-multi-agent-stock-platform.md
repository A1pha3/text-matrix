...
- 定义 TradingAgents-CN 是什么，以及它与原版 TradingAgents 的关系。
- 理解它当前已经公开实现的功能边界。
...
> **重要区分**：TradingAgents-CN 的重点不是"中文界面"，而是针对中文市场的数据源整合和多智能体研究流程的本地化适配。
...
对新手来说，建议先把系统定位学明白，再开始使用；对开发者来说，建议先理解多智能体协作流程，再决定如何扩展。
