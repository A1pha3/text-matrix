...
lastmod: 2026-04-04T14:35:00+08:00
categories: ["技术笔记"]
tags: ["AI平台", "RAG", "Deep Research", "Agent", "开源", "LLM", "企业搜索", "Python"]
...
```python
# Onyx RAG 工作流程
query → 混合索引检索 → Agent 二次检索 → 生成答案 → 答案验证
```
...
**相关链接：**
- 官网：[https://www.onyx.app](https://www.onyx.app)
- 文档：[https://docs.onyx.app](https://docs.onyx.app)
