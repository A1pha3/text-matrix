...
## 一、为什么 OpenCV 5.0 又一次冲上 GitHub Trending
...
### 3.3 与 PyTorch / ONNX Runtime 的边界
...
换句话说，5.0 让 OpenCV 在它本来就强的环节更强，但**不再试图成为「所有视觉任务的运行时」**。这是 14 年来最清醒的一次大版本升级。
