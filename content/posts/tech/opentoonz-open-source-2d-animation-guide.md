...
2016 年，DWANGO 将基于 Toonz Studio Ghibli Version 的代码库开源，发布为 OpenToonz。开源的目标有两个：一是让全球独立动画创作者能够使用这套专业工具；二是借助社区力量继续推进功能开发。原始 Toonz 代码的版权仍然归属于 Digital Video, S. p.A.（意大利），OpenToonz 的开源基于 DWANGO 的授权条款进行。
