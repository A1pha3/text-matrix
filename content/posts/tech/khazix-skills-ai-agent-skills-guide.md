...
1. **调查实验型**：亲自下场做一件事，然后报道发现。核心是"我替你去做了这件事"。
2. **产品体验型**：拿到产品实际使用，带着读者一起体验。核心是"跟我一起玩"。
3. **现象解读型**：观察到一个现象，层层深入分析。核心是"你注意到了吗？背后是什么？"
4. **工具分享型**：分享一个实用的工具/Prompt，用个人故事包裹。核心是"我发现了一个好东西"。
5. **方法论分享型**：把长期积累的经验系统分享。核心是"我把压箱底的东西掏给你了"。
...
这几个 Skill 都遵循 [Agent Skills](https://agentskills.io) 开放标准，这意味着：
