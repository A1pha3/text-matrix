...
- fucking-algorithm 的项目定位、学习方法和特色
- 算法学习的正确路径（先刷哪些题，再刷哪些题）
- vscode-leetcode VS Code 插件的使用
- 动态规划、链表、二叉树等主要数据结构
- 算法思维和刷题技巧
- 多语言版本的算法教程
...
LeetCode 上按题号顺序刷效率很低，这个项目的核心主张是：**先刷哪些题，再刷哪些题**，按专题路径推进。
...
**fucking-algorithm** 的核心价值在于提供了按专题组织的学习路径，避免盲目刷题。8+ 语言版本覆盖了不同母语的读者，VS Code 插件让刷题不用离开编辑器。
