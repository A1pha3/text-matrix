...
1. [核心判断](#一核心判断)
2. [Skill 结构](#二skill-结构4-个-markdown-文件各管一摊)
3. [规则覆盖范围](#三规则覆盖范围8-条主规则能改掉什么)
4. [Before/After 对照](#四5-段-beforeafter-看清ai-味长什么样)
5. [接入方式](#五接入方式4-条路径)
6. [采用顺序与适用边界](#六采用顺序与适用边界)
7. [总结](#七总结)
8. [自测题](#自测题)
9. [练习](#练习)
10. [进阶路径](#进阶路径)
...
- 为 Stop Slop 项目贡献中文规则集（Fork 仓库 → 补充 `phrases-zh.md` 和 `structures-zh.md` → 提 PR）
