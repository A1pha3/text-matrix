...
Copilot PR Reviewer 基于 GitHub Copilot SDK，每次 PR 自动分析改动、发现潜在问题、生成结构化审查意见。这篇文章覆盖安装配置、实践建议和 CI/CD 集成全流程。
...
3. **Token 限制**：超大型 PR（>500 文件）可能需要分批审查
