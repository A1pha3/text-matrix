...
- [二、DeepScientist 是什么？](#二deepscientist-是什么)
- [三、设计原则](#三设计原则)
- [四、为什么 DeepScientist 越用越好用？](#四为什么-deepscientist-越用越好用)
- [五、快速上手（30 秒）](#五快速上手30-秒)
- [六、界面选择](#六界面选择)
- [七、使用场景](#七使用场景)
- [八、模型配置](#八模型配置)
- [九、ResearAI 生态](#九researai-生态)
- [十、实践建议](#十实践建议)
- [十一、常见问题](#十一常见问题)
...
├── experiment/v2-改进方案A：改进方案 A 的实验
├── experiment/v3-改进方案B：改进方案 B 的实验
