...
> 导航：[下一节：n8n 在企业场景里靠什么站住脚](#n8n-在企业场景里靠什么站住脚) →
...
> 导航：← [学习目标](#学习目标) | [n8n 的系统地图](#n8n-的系统地图) →
...
> 导航：← [n8n 在企业场景里靠什么站住脚](#n8n-在企业场景里靠什么站住脚) | [与 Zapier、Make 的工程取舍](#与-zapiermake-的工程取舍) →
...
> 导航：← [n8n 的系统地图](#n8n-的系统地图) | [快速上手：从 npx 到 Docker](#快速上手从-npx-到-docker) →
...
> 导航：← [与 Zapier、Make 的工程取舍](#与-zapiermake-的工程取舍) | [工作流的核心抽象](#工作流的核心抽象) →
...
> 导航：← [快速上手：从 npx 到 Docker](#快速上手从-npx-到-docker) | [一次 AI Agent 工作流的完整路径](#一次-ai-agent-工作流的完整路径) →
...
> 导航：← [工作流的核心抽象](#工作流的核心抽象) | [400+ 集成背后的工程取舍](#400-集成背后的工程取舍) →
...
> 导航：← [一次 AI Agent 工作流的完整路径](#一次-ai-agent-工作流的完整路径) | [自托管部署的真实考量](#自托管部署的真实考量) →
...
> 导航：← [400+ 集成背后的工程取舍](#400-集成背后的工程取舍) | [企业级功能：什么时候需要](#企业级功能什么时候需要) →
...
> 导航：← [自托管部署的真实考量](#自托管部署的真实考量) | [自定义节点开发：何时该写、何时不该写](#自定义节点开发何时该写何时不该写) →
...
> 导航：← [企业级功能：什么时候需要](#企业级功能什么时候需要) | [实战场景与适用边界](#实战场景与适用边界) →
...
> 导航：← [自定义节点开发：何时该写、何时不该写](#自定义节点开发何时该写何时不该写) | [排查与运维](#排查与运维) →
...
> 导航：← [实战场景与适用边界](#实战场景与适用边界) | [采用顺序与决策建议](#采用顺序与决策建议) →
...
> 导航：← [采用顺序与决策建议](#采用顺序与决策建议) | [进阶路径](#进阶路径) →
