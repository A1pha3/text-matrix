...
description: "深度解析 Dimillian/Skills (2.8k Stars)：专注于 Apple 平台开发的可复用智能体技能集合，包含16个核心技能，覆盖App Store发布、SwiftUI重构、代码审查、bug调查等领域，采用自包含设计，每个技能独立完整可单独使用。"
---
...
**Dimillian/Skills**（[GitHub 仓库](https://github.com/Dimillian/Skills)）是由开发者 Dimillian 创建的可复用开发技能集合，专门针对 Apple 平台开发、GitHub 工作流、重构、代码审查和 bug 调查等场景。
...
*文档版本 1.0 | 撰写日期：2026-04-01 | 基于 Dimillian/Skills (2.8k Stars)*