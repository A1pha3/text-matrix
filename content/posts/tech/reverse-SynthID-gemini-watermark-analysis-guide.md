...
1. **了解 Reverse SynthID 项目**：理解其研究目标、核心发现和技术成果
2. **理解 SynthID 水印技术**：掌握其工作原理和嵌入方式
3. **掌握水印检测**：能够使用 Reverse SynthID 的检测器
4. **理解水印去除**：了解 V1-V3 三代去除技术的演进
5. **明确伦理边界**：理解水印技术的合法和伦理使用
...
|--------|-------------------|--------|------|
| **1024x1024** | (9, 9) | 100.0% | 100 黑+100 白参考图 |
...
2. 上传到 HuggingFace 数据集： PROTECTED_20 
