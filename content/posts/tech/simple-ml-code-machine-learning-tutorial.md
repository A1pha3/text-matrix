...
github_repo: "datawhalechina/simple-ml-code"
source_key: "gh:datawhalechina/simple-ml-code"
...
# Simple ML Code：机器学习入门实战教程

> Datawhale 出品的机器学习实战教程，从理论到代码，六大算法全覆盖

**覆盖范围**

- 六大机器学习算法的核心原理与数学推导
- NumPy、Matplotlib、scikit-learn 数据处理和模型训练
- 线性回归、决策树、SVM、K-means 等算法的代码实现
- 模型评估指标与可视化方法
...
[Simple ML Code](https://acgpp.github.io/simple-ml-code/) 是 Datawhale 开源社区的机器学习实战教程项目，面向初学者，从零开始讲解基础算法。
...
| 章节 | 算法 | 类型 | 应用场景 |
|------|------|------|----------|
| 第 1 章 | 线性回归 | 监督学习-回归 | 房价预测、趋势分析 |
| 第 2 章 | 逻辑回归 | 监督学习-分类 | 二分类问题 |
| 第 3 章 | 决策树 | 监督学习-分类 | 风险评估、用户分类 |
| 第 4 章 | 支持向量机 | 监督学习-分类 | 文本分类、图像识别 |
| 第 5 章 | K-means | 无监督学习-聚类 | 用户分群、异常检测 |
| 第 6 章 | 朴素贝叶斯 | 监督学习-分类 | 垃圾邮件检测、文本分类 |
