...
github_repo: "google-ai-edge/gallery-ios"
source_key: "gh:google-ai-edge/gallery-ios"
description: "Google AI Edge Gallery 是 Google 推出的本地 ML/GenAI 展示与应用平台，支持在浏览器和移动设备上运行 AI 模型。"
draft: false
categories: ["技术笔记"]
tags: ["本地部署", "GenAI", "Kotlin"]
---
...
该项目由 Google AI Edge 团队维护。用户可以直接试用各种模型，理解其工作原理，并在自己的应用中复现这些功能。
