...
source_key: "gh:siddharthvaddem/openscreen"
...
- openscreen 的定位和适用场景
- 安装和配置方法
- 使用 openscreen 创建产品演示视频
- 技术架构和扩展开发方法
- 在项目中集成 openscreen 进行自动化 demo 生成

## §2 原理分析

### 2.1 项目解决什么问题

在产品开发过程中，录制高质量的 demo 视频一直是开发者的痛点。商业工具如 Screen Studio 价格昂贵，且存在水印和使用限制。openscreen 是 Screen Studio 的开源替代方案，免费、无水印、商用友好。
