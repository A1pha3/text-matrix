...
下面会覆盖 FA1/FA2/FA3 三代的原理差异、安装与 API 调用、与 HuggingFace/xFormers/Megatron-LM 的集成、benchmark 怎么读、训练与推理场景的注意点、常见报错排查。CUTLASS 内核细节、Triton 实现版本、Flash Attention-4（Blackwell 专属，仍在快速迭代）不在范围内。
