...
github_repo: "EbookFoundation/free-programming-books"
source_key: "gh:EbookFoundation/free-programming-books"
...
这个项目不是托管书籍本身，而是维护一个**精心策划的链接列表**，指向互联网上合法免费提供的优质编程学习资源。
...
不可以。这个列表**只收录书籍**，不收录视频课程、博客或教程网站。
...
**练习 1：找到适合你的 Python 书籍**  
使用 free-programming-books 资源：
1. 打开 `books/python.free-programming-books.md` 文件
2. 找出 3 本适合初学者的书籍
3. 找出 2 本适合进阶学习者的书籍
4. 选择一本你最感兴趣的书籍，开始阅读

**练习 2：贡献一本新书**  
为 free-programming-books 项目贡献一本免费书籍：
1. Fork 仓库到你的 GitHub 账号
2.  clone 你的 Fork 到本地
3.  创建新分支：`git checkout -b add-new-book`
4.  编辑对应语言的文件，添加一本免费书籍
5.  提交 PR

**练习 3：使用 GitHub 搜索技巧**  
使用本文介绍的 GitHub 搜索技巧：
1. 搜索 free-programming-books 仓库中的 "machine learning" 相关书籍
2. 找出 3 本免费的机器学习书籍
3. 验证这些书籍的链接是否有效
...
**练习 4：构建个人学习路径**  
使用 free-programming-books 构建你的个人学习路径：
1. 选择你想学习的编程语言或技术
2. 从 free-programming-books 中找出 5 本相关书籍
3. 按难度排序（入门 → 进阶 → 高级）
4. 制定 3 个月的学习计划
...
完成以下清单，确认你已掌握 free-programming-books 的核心使用能力：

- [ ] 我能高效浏览和搜索 free-programming-books 资源库
- [ ] 我能按编程语言、主题和难度找到合适的书籍
- [ ] 我理解贡献指南和社区规范
- [ ] 我能为我熟悉的语言贡献免费书籍
- [ ] 我能验证书籍链接的有效性和质量
- [ ] 我能使用 free-programming-books 构建个人学习路径
- [ ] 我知道如何处理常见问题（链接失效、书籍不再免费等）
- [ ] 我发现适合不同水平开发者的优质免费学习资源
