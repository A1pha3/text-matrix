...
github_repo: "onevcat/2026-vision"
source_key: "gh:onevcat/2026-vision"
aliases:
...
很多人看到这个仓库，第一反应是“onevcat 把演讲稿开源了”。但认真翻一遍目录，真正有价值的是**一整套可复用的工程化工作流**：观点池、结构规划、引用清单、完整讲稿笔记、设计批评记录、提取 speaker notes 的脚本，以及面向 Agent 的技能目录——PDF 只是其中一份产出物。
...
| `.agents/`、`.claude/`、`skills/` | Agent 相关技能与协作资产 | 作者把 AI 当作可配置的工作流组件，而不是一次性聊天工具 |
...
它的价值在于把很多“PPT 看着不对劲”的问题拆解成了可操作判断，例如：
...
个人视角下，减少重复解释和重复踩坑。团队视角下，把少数高手的经验，变成更多人和更多 Agent 都能继承的基础设施。
