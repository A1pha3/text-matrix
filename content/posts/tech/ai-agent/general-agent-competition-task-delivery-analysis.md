...
draft: false
categories: ["技术笔记"]
tags: ["Manus", "Genspark", "Flowith", "AI Agent", "行业分析"]
---

> **难度**：⭐⭐⭐⭐ | **类型**：深度分析 | **预计阅读时间**：32 分钟
> **目标读者**：关注 AI Agent 产业趋势的产品经理、创业者、工程师、研究者与企业决策者
> **核心判断**：通用 Agent 的竞争单位，正在从"谁的模型更强"切换为"谁能成为默认任务承接方"
> **来源**：清华大学清新研究团队《全球通用智能体竞争报告》，2026 年 3 月版本

---

# 全球通用智能体竞争报告深度解读：通用 Agent 的真正战场，已经从模型切到任务交付

这份报告最有价值的地方，不在于又罗列了一遍模型公司和产品名单，而在于**重新定义了研究对象**。

过去很多"通用智能体"讨论，实际上还停留在模型竞赛范式里：比参数、比基准、比推理能力和工具调用，最多再加一个 Browser Use（浏览器使用）或 Computer Use（电脑使用）。但这份报告明确提出：**真正值得单独研究的，是把任务接过去、做出来、交付掉的产品层 Agent，而不是模型原语。**
...
这份报告发布于 2026 年 3 月，Manus 此后的公司走向一波三折：4 月，Meta 宣布以超过 20 亿美元收购 Manus，交易随即被中国监管部门否决；7 月，据《金融时报》报道，腾讯牵头安排撤销交易；8 月起 Manus 确认恢复独立运营，9 月据报道正寻求以 40 亿美元估值进行新一轮融资。公司归属几经波折，但报告所描述的"任务交付型 Agent"产品定位没有变化。

### 4.2 Genspark：把通用 Agent 做成一体化工作台

如果说 Manus 代表"强执行代理"，那 Genspark 代表的是另一条路线：**Agent-Native（原生 Agent 化）的生产力套件。**

报告对 Genspark 的定义非常清楚：它不只是一个单一的 Super Agent，而是一个 all-in-one AI workspace（全栈 AI 工作台），把 Docs、Sheets、Slides、Designer、Teams、Developer 等模块统一到一个入口里。
...
这说明 Flowith 要解决的问题不是"一次任务能不能做完"，而是：
...
这些能力很重要，因为它们决定了产品层 Agent"能不能做"。

原语层的产品载体更替得很快：报告提到的 Operator，早在 2025 年 8 月底就已关停，浏览器操作能力由 ChatGPT agent 接棒；而 ChatGPT agent 本身也在 2026 年 8 月初从 ChatGPT 中移除，用户被引导向 ChatGPT Work 和独立的云端浏览器功能。这一层的能力在沉淀，具体产品形态却一直在换。
...
报告强调"原语层不等于最终产品层"，这个判断成立。但如果进一步往下推，还应该加一句：
...
也就是说，Devin 的强项不是"面向所有任务的广覆盖"，而是"在软件工程任务里形成足够深的闭环"。
...
因此，更准确的产业图景不是"Manus 或 Devin 二选一"：
...
报告列出了 5 个关键竞争维度：任务交付、环境控制、记忆、入口、治理。这 5 个维度贴近真实产业逻辑，值得进一步展开成一套更完整的原理框架。

### 7.1 维度一：任务交付能力

这是最核心的维度。

任务交付能力不是"会调用几个工具"，它至少包括：
...
记忆不是锦上添花，而是 Agent 从"会一次"走向"越用越像同事"的前提。
...
所以我非常认同报告把治理列为核心维度之一。也就是说，通用 Agent 的竞争，已经不是单纯的模型能力竞争，而是**产品、系统、组织控制面**的综合竞争。
...
《全球通用智能体竞争报告》最值得肯定的地方，不在于它给出了一个绝对答案，而在于它把问题问对了。
...
本文是对清华大学清新研究团队 2026 年 3 月发布的《全球通用智能体竞争报告》的解读，文中报告观点与产品描述均为报告口径的转述。核实与延伸信息来自以下公开渠道：

- **报告本体**：清华大学清新研究团队《全球通用智能体竞争报告》（2026 年 3 月）。报告核心论断——竞争从模型层转向产品层、以 Manus/Genspark/Flowith 为核心分析对象、强调任务交付与工作台入口——见多家公开转载版本（电子工程专辑 2026-03-24、各微信公众号转载）。
- **Manus**："autonomous general AI agent""拥有自己电脑的虚拟同事"为其 2025–2026 年初官网自述口径；公司归属后续变化见 BBC（2026-04-27，中国监管部门否决 Meta 收购）、Financial Times（2026-07-09，腾讯牵头撤销交易）、CNBC（2026-08-11，恢复独立运营）、TechCrunch（2026-09-18，寻求 40 亿美元估值新融资）等报道。
- **OpenAI**：Operator 于 2025-01-23 发布、2025-08-31 关停，浏览器操作能力由 ChatGPT agent 接棒；ChatGPT agent 于 2026 年 8 月初从 ChatGPT 移除，用户被引导至 ChatGPT Work 与独立云端浏览器功能（Wikipedia "OpenAI Operator" 词条及 OpenAI 帮助中心）。
- **Google**：Project Mariner 为 Google DeepMind 浏览器操作研究原型，2025 年 5 月起向 AI Ultra 订阅用户开放，并逐步集成进 Gemini API 与 Vertex AI（Google 官方博客与 Wikipedia 词条）。
- **Genspark / Flowith / Devin**：Genspark 的 Super Agent 与 AI Workspace 定位、Flowith 的"面向智能体时代的行动型 OS"定位（2026-03 种子轮融资报道）、Devin 的 "AI software engineer" 官方定位，分别见 Cybernews、AFFiNCO、Pandaily（2026-03-03）、PR Newswire 等公开报道。

**口径说明**：报告原文以产品层/原语层/垂直代理层三层框架组织，本文的"5 个竞争维度""5 个原创概念"等归纳为报告口径转述；文中对三家产品层产品与原语层玩家的定性描述，均以报告发布时点（2026 年 3 月）为准，产品存续状态已按 2026 年 9 月可核实的公开信息补注。
