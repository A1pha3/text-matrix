...
description: "深度解析 Agency Agents (2.4k Stars)：轻量级多智能体工作流框架，基于Claude API构建，支持高级记忆管理、推理能力、工具使用和流式响应，采用TypeScript编写，提供简洁API设计，适合快速构建多智能体原型和中等复杂度工作流，MIT许可证。"
---
...
*文档版本 1.0 | 撰写日期：2026-04-01 | 基于 Agency Agents (2.4k Stars, MIT)*