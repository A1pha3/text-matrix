...
2026年4月，清华大学 SAGA 实验室发布了一个开源项目，名叫 **Syll**。
...
从研究贡献的角度，Syll 的四个设计ideas（persona as config、lore fragments、agent-judged silence、confirmation-first）各自独立成篇，但组合在一起指向同一个问题：**AI Companion 的"温度"从哪里来？**
