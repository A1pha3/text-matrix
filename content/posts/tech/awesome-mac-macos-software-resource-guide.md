...
awesome-mac：K Stars·macOS 软件资源大全·开发者工具/设计/媒体/效率工具·Homebrew/Mac App Store
...
**定位**：为 macOS 用户提供一站式的软件推荐导航，从开发环境到日常效率工具全覆盖。
...
OneDrive
https://www.microsoft.com/en-us/microsoft-/onedrive
...
**awesome-mac** 收录了 17k Stars 的 macOS 软件资源，从开发者工具到日常效率工具全覆盖，安装方式以 Homebrew 为主，社区持续维护，CC0-1.0 许可证。
