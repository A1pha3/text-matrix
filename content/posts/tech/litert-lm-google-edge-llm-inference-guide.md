...
github_repo: "google-ai-edge/LiteRT-LM"
source_key: "gh:google-ai-edge/LiteRT-LM"
...
LiteRT-LM 是 Google 在边缘设备 LLM 推理上的生产级方案。选择它的理由：
...
如果你需要在手机、IoT 或浏览器里跑 LLM，LiteRT-LM 是目前少数经过大规模生产验证的选项之一。
