...
## §5 hashline 状态机：stale tag、recovery、renumber
...
## §6 真实编辑示例：str_replace vs hashline
...
## §8 与 Claude Code / Gemini CLI / Aider 的对比
