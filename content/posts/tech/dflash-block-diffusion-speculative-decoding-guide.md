...
数据与代码来自 [z-lab/dflash](https://github.com/z-lab/dflash)、论文 [arXiv:2602.06036](https://arxiv.org/abs/2602.06036) 与 Hugging Face 模型集合，本次核验日期 2026-09-14。
...
2026 年 8 月 18 日，官方发布 DFlash 2，首批权重为 Muse-Glimmer-30B 与 Qwen3.8-27B 两个检查点（见 [DFlash 2 集合](https://huggingface.co/collections/z-lab/dflash-2)）。骨架和初版一致，块扩散草案、目标模型上下文条件化、并行验证都没有动；它做的是在骨架上补两个小组件：
