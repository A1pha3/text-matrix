...
| **SANA-WM** | 可控世界模型 | 720p、1 分钟、6-DoF 相机控制 |
...
SANA 的出现重新定义了"高效扩散模型"的标准。线性注意力的引入不仅是工程上的优化，更是一种架构思路的转变——在高分辨率生成任务上，架构效率的提升和 scale up 一样能带来质的飞跃。如果你正在找一个既快又好的开源图像/视频生成方案，SANA 家族值得重点关注。
