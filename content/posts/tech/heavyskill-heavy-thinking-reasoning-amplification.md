...
source_key: "gh:wjn1996/HeavySkill"
...
- 解释传统单链式推理（CoT）的三个根本性缺陷
- 说出 HeavySkill 的两阶段推理架构（并行推理 + 顺序深思）
- 解释顺序深思如何批判性分析多条推理轨迹
- 在 Claude Code 中配置和使用 HeavySkill
- 判断你的推理任务是否适合用 HeavySkill
