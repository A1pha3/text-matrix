...
1. **[`README.md`](https://github.com/open-gsd/get-shit-done-redux/blob/main/README.md)**：先确认项目定位、安装命令、支持的运行时和当前维护链
2. **[`docs/USER-GUIDE.md`](https://github.com/open-gsd/get-shit-done-redux/blob/main/docs/USER-GUIDE.md)**：把第一轮完整工作流从头到尾走一遍
3. **[`docs/ARCHITECTURE.md`](https://github.com/open-gsd/get-shit-done-redux/blob/main/docs/ARCHITECTURE.md)**：在你真正想理解“为什么它这样设计”时再读

如果你已经能接受它的主张，再去看 [`docs/COMMANDS.md`](https://github.com/open-gsd/get-shit-done-redux/blob/main/docs/COMMANDS.md) 和 [`docs/CONFIGURATION.md`](https://github.com/open-gsd/get-shit-done-redux/blob/main/docs/CONFIGURATION.md) 就行。先把主循环跑通，比先把所有开关背下来更重要。
