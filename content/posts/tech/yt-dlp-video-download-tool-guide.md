...
这是一款命令行工具，支持超过一千个视频网站，从 YouTube、TikTok 到各种小众站点通吃。它从 youtube-dl fork 而来，目前 GitHub Stars 已超过 16 万，是同类工具中最活跃的分支。下面覆盖安装、主要用法、格式选择、元数据处理、插件开发，并拆解其架构设计。
...
yt-dlp 是命令行视频下载领域维护最活跃的工具。超过一千个 Extractor 支撑的网站覆盖、精细的格式选择机制、灵活的后处理管道，加上始终跟得上网站反爬更新的维护节奏，构成了它的核心壁垒。
