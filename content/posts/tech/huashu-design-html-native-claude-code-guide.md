...
**Huashu Design**（花叔Design）是目前 AI Agent 设计工具领域最具影响力的开源 skill 之一，由独立开发者花生（花叔）创建，于 2026-04-19 公开，不到两周时间即斩获超过 10,000 star，fork 数高达 1,478，成为 GitHub Trending 榜上的现象级项目。
...
借鉴自 **Remotion** 的设计思想，但做了极简化的轻量实现。核心概念只有两个：
...
不是绑定某个特定 AI Agent，而是以 skill 为单位输出，任何支持 skills.sh 协议的平台都可以使用。这意味着设计能力可以在不同 Agent 之间无缝迁移。
