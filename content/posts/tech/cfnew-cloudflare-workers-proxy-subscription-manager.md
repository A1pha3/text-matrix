...
CFnew 是一个功能完整的 Cloudflare 代理订阅管理器，图形界面 + 多协议支持 + 多格式导出，适合需要在多个代理客户端之间切换、对订阅管理有较高要求、同时希望基础设施成本极低（Cloudflare Workers 免费额度足够个人使用）的用户。