...
- 理解 Agent Skills 的定位——将资深工程师的实践建议封装成 AI 可复用的技能
...
核心理念：
> "Skills encode the workflows, quality gates, and practices that senior engineers use when building software."
