...
description: "详解 Anthropic 长时运行 Agent Harness 的演进：从 Initializer/Coding Agent 到 Planner-Generator-Evaluator，以及 Context Reset 与 AutoResearch 范式。"
---
...
**关键发现**：在 Anthropic 早期实验里，Claude Sonnet 4.5 表现出明显的上下文焦虑，仅靠压缩难以稳定支撑长任务，因此 Context Reset 一度成为关键设计。
