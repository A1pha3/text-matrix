...
本文梳理了当前最核心的 **12 个 AI 应用技术主题**，并规划了完整的学习路线。适合开发者从零建立系统认知或查漏补缺。
...
> 💡 **选择建议**：部署成本随参数量指数级上升。建议先用 7B-8B 小模型验证 Pipeline，仅在推理能力触顶时再考虑 70B+ 模型。
...
> 💡 **核心定律**：生产环境中的智能系统效果 = 20%的智能体自由发挥 + 80%的确定性工作流管道。
...
⬆️ [返回目录](#目录) | ⬆️ [上一节：Context Engineering](#8-context-engineering上下文工程-) | ⬇️ [下一节：OpenClaw](#11-openclaw开源智能体框架-)
...
最后，我们通过一个完整的企业知识库问答系统，将 RAG、Function Calling 与智能体架构进行串联实战。
