...
软件开发的**核心挑战是管理复杂性**。复杂性不是由单一灾难性错误导致，而是通过成千上万个小决策逐渐累积。
...
**核心洞察**: 复杂性是递增的。必须采取**零容忍**心态——每一丝"微小"的复杂性都值得重视。
...
**核心原则**: 当复杂性不可避免时，**模块应内部吸收它**，而不是推给调用者。
...
**核心洞察**: 异常处理是复杂性的最大来源之一。减少必须处理的异常数量是降低复杂性的最佳技术之一。
...
**参考书籍**: John Ousterhout《A Philosophy of Software Design》是软件工程领域的经典，本 Skill 将其核心原则凝练为可操作的 AI Agent 指导。
