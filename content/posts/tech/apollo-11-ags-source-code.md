...
Apollo-：阿波罗 号制导计算机源码探秘——K Stars 的人类登月编程遗产
...
1. AGC 的历史地位：为何这个 16 斤重、4KB 内存的计算机能送人类登月
...
A：1202 表示 "Executive overflow - no jobs"。也就是调度器没有可执行的任务。软件设计允许在紧急情况下忽略非关键任务。
