...
description: "Twenty 是 42.6k Stars 的开源 CRM 平台，Salesforce 的现代替代品。本文全面介绍其功能架构、技术栈、权限系统、工作流、API 集成和推荐做法。"
draft: false
categories: ["技术笔记"]
tags: ["CRM", "开源", "TypeScript", "NestJS", "GraphQL"]
---

# Twenty：开源CRM的完整技术指南与推荐做法

## 一、项目概览

**Twenty** 是一个现代化的开源 CRM（客户关系管理）平台，定位是 Salesforce 的开源替代品。凭借现代化的技术栈、清晰的架构设计和完善的功能生态，Twenty 正在吸引越来越多开发者和企业的关注。

该项目在 GitHub 上获得了 **42.6k Stars** 和 **5.6k Forks**，拥有 **604 位贡献者**。
