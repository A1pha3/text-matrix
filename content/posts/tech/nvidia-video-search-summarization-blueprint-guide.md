...
source_key = "gh:NVIDIA-AI-Blueprints/video-search-and-summarization"
...
| **Long Video Summarization（LVS）** | 对长视频进行分块 Dense Captioning 和聚合摘要，适合数小时级别的录像分析 | [LVS](https://docs.nvidia.com/vss/3.1.0/agent-workflow-lvs.html) |
...
NVIDIA VSS Blueprint 为视频智能分析提供了一个**从底层推理加速到上层智能体编排的完整参考实现**：

1. **5 种开箱即用的工作流**，覆盖搜索、摘要、问答、告警验证等主流场景
