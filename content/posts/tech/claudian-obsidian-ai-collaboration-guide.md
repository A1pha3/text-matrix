...
**核心特性**：选中文字+快捷键，直接在笔记中进行 AI 编辑，带词级别 diff 预览。
...
Claudian 重新定义了笔记工具的边界：

- ✅ **AI 嵌入**：Claude Code 成为笔记的一部分
- ✅ **双向交互**：笔记不仅是 AI 的输入，更是 AI 的工作目录
- ✅ **工具调用**：内置+MCP 扩展的强大能力
- ✅ **Plan Mode**：人工可控的 AI 执行
- ✅ **多会话管理**：复杂任务的多视角处理
- ✅ **隐私优先**：本地存储，无遥测
