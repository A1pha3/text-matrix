...
ArcKit: Stars 的企业架构治理与供应商采购工具包--从入门到精通
...
** PROTECTED_27 ** 使用 Platform Design Toolkit 设计平台战略:
...
** PROTECTED_29 ** 生成 UK GDPR Article 35 合规的 DPIA:
...
** PROTECTED_30 ** 进行 Build vs Buy 分析:
...
** PROTECTED_34 ** 和 ** PROTECTED_35 ** 针对国防 AI 系统:
...
| 平台 | 完整度 | 说明 |
|------|--------|------|
| **Claude Code Plugin** | ⭐⭐⭐⭐⭐ | 首选体验:68 命令 + 10 研究代理 + 5 自动化钩子 |
| **Gemini CLI Extension** | ⭐⭐⭐⭐⭐ | 完整支持:68 命令 + MCP 服务器 |
| **GitHub Copilot** | ⭐⭐⭐⭐ | 68 prompt 文件 + 10 agent 定义 |
...
Wardley Mapping 是 Simon Wardley 创建的一种战略规划工具,通过在演化轴上定位组件(从 Genesis 到 Commodity)来揭示竞争动态和技术成熟度。
...
. ArcKit 中的 Wardley Mapping

** PROTECTED_36 ** 自动生成 Wardley 图,支持平台战略设计:
...
✅ /arckit-mod-secure"]
    ...
    GOV & BIZ & VENDOR & SEC --> PHASE["选择 Phase"]
    PHASE --> P0["Phase 0
战略规划"]
    PHASE --> P1["Phase 1
Discovery"]
