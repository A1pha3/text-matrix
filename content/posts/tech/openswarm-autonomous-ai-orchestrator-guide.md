...
github_repo: "unohee/OpenSwarm"
source_key: "gh:unohee/OpenSwarm"
...
draft: false
categories: ["技术笔记"]
tags: ["AI Agent", "Claude Code", "多智能体"]
---
...
OpenSwarm 的思路：**把 Claude Code 变成一个可以编排、可以协同、可以记忆的 Agent 系统**。
...
这是 OpenSwarm 的关键设计：**双 Agent 协作生成代码**。
...
OpenSwarm 做的事很明确：**把单 Agent 变成多 Agent 协同**——Worker/Reviewer 配对、LanceDB 长期记忆、Discord 实时控制，一条线串起来。

优势：

1. **自动化**：从 Linear 问题到 PR 的完整流水线
