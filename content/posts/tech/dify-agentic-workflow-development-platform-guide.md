...
Dify 的开源协议基于 Apache 2.0，额外增加了一些条件（主要限制商用时请勿直接用 Dify 品牌做产品化），具体参考 [LICENSE](https://github.com/langgenius/dify/blob/main/LICENSE) 文件。希望将 Dify 集成到商业产品中的团队，可以联系官方了解企业版授权。
