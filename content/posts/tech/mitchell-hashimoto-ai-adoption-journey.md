...
Mitchell Hashimoto 是知名的工程师（HashiCorp 联合创始人、多款明星开源项目作者），在技术圈以严谨著称。作者本身对 AI 编程工具经历了一个完整的"不信→试用→受挫→强迫自己→顿悟→依赖"的过程，且每一步都有具体的操作细节，不是空洞的"AI 太牛了"感叹。
...
> 用聊天界面做有意义的编码工作，效率极低。必须转向 Agent。
...
> 买了 Claude Code 却效果不好？正常。但你还没有真正学会用它。
...
> 每天最后 30 分钟，批量跑 Agent，把"你不能工作的时间"变成 Agent 的工作时间。
...
> 把自己有高确定性能处理好的任务全部交给 Agent，然后专注于自己真正喜欢的工作。
...
到了这个阶段，他进入了"绝对回不去"的领地——感觉效率明显更高，而且**他可以把 coding 和思考的精力集中在那些他真正喜欢的任务上，同时那些他不喜欢但又必须做的任务也被好好完成了**。

---

## 第五步：工程化 Harness

> 每次 Agent 犯错，花时间设计机制让它不再犯，而不是反复手动纠正。

这是 Hashimoto 目前的重心所在。

他的判断是：**Agent 效率的最高表现形式是一次性做对，或者退一步说——产出只需极少量润色的结果**。实现这个目标的最可靠方法，是给 Agent 快速、高质量的自动校验工具，让它自己知道什么时候做错了。
...
> 没有 Agent 在跑的时候，问自己——"现在有什么 Agent 可以帮我做的事？"
...
这篇文章没有在喊"AI 取代程序员"，也没有在危言耸听"AI 让新人失去技能"。它描述的是一个**理性的、有经验的技术人在有一套成熟工作流的前提下，如何逐步把 AI 工具整合进去**。

路径很清晰：从"委托"开始，而不是从"聊天"开始；接受迭代，不要幻想一次搞定；工程化地消除错误，而不是只接受错误。
