...
但这篇论文不能直接写成“AI 会系统性损害大脑”。它是特定任务、特定样本、特定实验设置下的研究，目前仍是预印本，后续也已经引发了一些方法学层面的公开讨论。看这篇论文，更稳的姿势是把它当警报，别当判决书。它提醒我们，**把写作最核心的那一段直接交给 LLM，可能不是节省，而是透支。**
...
这篇论文最重要的结论，不是“用了 AI 就不思考”，而是**批判性思维会被重新分配，甚至被重新定价**。一些人会把认知努力从“自己想答案”转移到“验证、修订、整合 AI 输出”；另一些人则在对 AI 过度信任时，直接减少检查和推理投入。
...
这篇论文最强的地方，在于它把一个容易被说成鸡汤的口号变成了可操作的设计语言。"不要太依赖 AI"没有流程设计，很快就沦为空话；"保留认知摩擦"的要害在于：先自己写结论、先自己列假设、先自己复述再看 AI——这些动作不能交给自动生成。
...
把 AI 放在“给结论”的位置上，价值有限；让它生成反对意见、暴露替代解释、补出你没想到的反例，价值反而更高。这个结论和前面几篇研究是吻合的，因为这种情况下人的角色不是复制，而是裁决。
...
这四问保的不是“人必须比 AI 更强”，保的是“最终判断必须仍然属于人”。
