...
| 维度 | 关键信息 |
|------|----------|
| 仓库 | HKUDS/Vibe-Trading（github.com/HKUDS/Vibe-Trading） |
| 官网 | vibetrading.wiki（vibetrading.wiki） |
| 文档 | vibetrading.wiki/docs（vibetrading.wiki/docs） |
| PyPI | pypi.org/project/vibe-trading-ai（pypi.org/project/vibe-trading-ai） |
| 许可证 | MIT |
