...
- `write-cn-doc`：先过选题价值 gate（本文提供了什么读者已有渠道没有的东西？答不上来先收敛选题），再定章节骨架 + 目标读者 + 学习路径/级别
...
4. 去 AI 味后各维度评分是否持平或提升
5. 若为开源项目解读、架构分析、benchmark 解读、技术博客或系统评测，确认已路由至 `cn-tech-blog-writer`
